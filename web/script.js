document.addEventListener('DOMContentLoaded', () => {
    ...
    function showYearsList() {
        ...
        yearsListDiv.classList.remove('hidden');
        daysListDiv.classList.add('hidden');
        problemSolverDiv.classList.add('hidden');
    ...
    function showDaysList(year) {
        ...
        currentYear = year;
        yearsListDiv.classList.add('hidden');
        daysListDiv.classList.remove('hidden');
        problemSolverDiv.classList.add('hidden');
    ...
    function showProblemSolver(year, day) {
        ...
        yearsListDiv.classList.add('hidden');
        daysListDiv.classList.add('hidden');
        problemSolverDiv.classList.remove('hidden');
    ...
    async function solvePuzzle() {
        ...
        if (textInput && file) {
            inputError.textContent = 'Please provide input either via text field OR file, not both.';
            return;
        }
        ...
        try {
            const response = await fetch(`/api/years/${currentYear}/days/${currentDay}`, {
                method: 'POST',
                headers: {
